        ...
        <div className="container mx-auto px-3 sm:px-4 lg:px-6">
          <div className="flex justify-between items-center py-3 sm:py-4">
            ...
            <div className="flex items-center space-x-1.5 sm:space-x-2 lg:space-x-3">
              {/* Ícone de Restrição de Idade - Sempre visível */}
              ...
              {!loading && (
                user ? (
                  <div className="flex items-center space-x-1.5 sm:space-x-2">
                    ...
                    <button onClick={logout} className="px-2 py-1.5 sm:px-3 sm:py-2 text-xs sm:text-sm bg-red-600 text-white rounded-md hover:bg-red-700 transition-colors">
                      Sair
                    </button>
                  </div>
                ) : (
                  <button onClick={signInWithGoogle} className="px-2 py-1.5 sm:px-3 sm:py-2 text-xs sm:text-sm bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors font-medium">
                    Login Google
                  </button>
                )
              )}
