...
const DICTS = {
  pt: {
    ...
    'Tente ajustar os filtros ou explore outras categorias.': 'Tente ajustar os filtros ou explore outras categorias.',
     ...
     'Buscando por:': 'Buscando por:',
     'Relevância': 'Relevância',
     'Título': 'Título',
     'Pontuação': 'Pontuação',
     'Nenhum anime encontrado': 'Nenhum anime encontrado',
     'Não encontramos animes para': 'Não encontramos animes para',
     'Tente:': 'Tente:',
     'Verificar a ortografia': 'Verificar a ortografia',
     'Usar termos mais gerais': 'Usar termos mais gerais',
     'Tentar sinônimos': 'Tentar sinônimos',
     'Explorar Animes': 'Explorar Animes',
     'Sugestões': 'Sugestões',
     'Buscas Recentes': 'Buscas Recentes',
     'Populares': 'Populares',
     'Buscando sugestões...': 'Buscando sugestões...',
     'Tentar novamente': 'Tentar novamente',
     'Ver Detalhes': 'Ver Detalhes',
     'Em Exibição': 'Em Exibição',
     'Finalizado': 'Finalizado',
     'Não Exibido': 'Não Exibido',
     'episódios': 'episódios',
  ...
  en: {
    ...
    'Tente ajustar os filtros ou explore outras categorias.': 'Try adjusting the filters or explore other categories.',
     ...
     'Pontuação': 'Score',
     'Nenhum anime encontrado': 'No anime found',
     'Não encontramos animes para': 'We didn\'t find anime for',
     'Tente:': 'Try:',
     'Verificar a ortografia': 'Check spelling',
     'Usar termos mais gerais': 'Use more general terms',
     'Tentar sinônimos': 'Try synonyms',
     'Explorar Animes': 'Explore Animes',
     'Sugestões': 'Suggestions',
     'Buscas Recentes': 'Recent Searches',
     'Populares': 'Popular',
     'Buscando sugestões...': 'Searching suggestions...',
     'Tentar novamente': 'Try again',
     'Ver Detalhes': 'View Details',
     'Em Exibição': 'Currently Airing',
     'Finalizado': 'Finished',
