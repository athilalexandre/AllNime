...
import { ArchiveX } from 'lucide-react'; // Ícone alterado
...
const DroppedPage = () => {
  ...
  const listType = LIST_TYPES.DROPPED; // Tipo de lista para esta página
  const pageTitle = "Animes Desistidos"; // Título da página
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-3 mb-6 border-b border-gray-300 dark:border-gray-700 pb-4">
        <ArchiveX size={32} className="text-primary-light dark:text-primary-dark" /> {/* Ícone alterado */}
