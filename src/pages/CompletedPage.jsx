...
import { CheckCheck } from 'lucide-react'; // Ícone alterado
...
const CompletedPage = () => {
  ...
  const listType = LIST_TYPES.COMPLETED; // Tipo de lista para esta página
  const pageTitle = "Animes Completos"; // Título da página
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-3 mb-6 border-b border-gray-300 dark:border-gray-700 pb-4">
        <CheckCheck size={32} className="text-primary-light dark:text-primary-dark" /> {/* Ícone alterado */}
