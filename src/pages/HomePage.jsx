    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
      ...
      <div className="text-center">
        ...
        <p className="max-w-2xl mx-auto mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
          {translate('Descubra, organize e acompanhe seus animes favoritos. Uma plataforma completa para gerenciar sua jornada pelo mundo dos animes.')}
        </p>
      </div>
      ...
      <div className="px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          <div className="text-center">
            ...
            <h3 className="mb-2 text-xl font-semibold text-gray-900 dark:text-white">{translate('Descubra Animes')}</h3>
            <p className="text-gray-600 dark:text-gray-400">{translate('Encontre novos animes através de nossa busca avançada e recomendações personalizadas.')}</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="mb-2 text-xl font-semibold text-gray-900 dark:text-white">{translate('Organize sua Lista')}</h3>
            <p className="text-gray-600 dark:text-gray-400">{translate('Mantenha controle dos animes que está assistindo, planeja assistir ou já completou.')}</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="mb-2 text-xl font-semibold text-gray-900 dark:text-white">{translate('Avalie e Comente')}</h3>
            <p className="text-gray-600 dark:text-gray-400">{translate('Compartilhe suas opiniões e veja o que outros usuários pensam sobre os animes.')}</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl">
            {translate('Comece sua jornada hoje')}
          </h2>
          <p className="max-w-2xl mx-auto mt-4 text-lg text-gray-600 dark:text-gray-400">
            {translate('Junte-se à comunidade AllNime e descubra um mundo de animes incríveis.')}
          </p>
          <div className="mt-8">
            <Link
              to="/explore"
